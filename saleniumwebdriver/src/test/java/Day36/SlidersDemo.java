...
public class SlidersDemo {
    ...
    System.out.println(" Default location of the emin slider:"+min_slider.getLocation());//(59, 250)  (x,y)
   ...
   WebElement max_slider=driver.findElement(By.xpath("//span[2]"));
    System.out.println(" Default location of the emin slider:"+max_slider.getLocation());//(876, 249)  (x,y)
